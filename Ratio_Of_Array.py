...
0.400000
0.200000
-> Function Description: Complete the plusMinus function in the editor below. plusMinus has this parameter(s): int arr[n]: an array of integers
...
-> Constraints :  0 < n <= 100  and  -100 <= arr[i] <= 100
-> Output Format: Print the following 3 lines, each to  decimals:
   1. proportion of positive values, 2.proportion of negative values, 3.proportion of zeros
-> Sample Input: 
STDIN           Function                           OutPut
-----           --------                       -------------
6               arr[] size n = 6                0.500000
-4 3 -9 0 4 1   arr = [-4, 3, -9, 0, 4, 1]      0.333333
                                                0.166667
-> Explanation: There are 3 positive numbers, 2 negative numbers, and 1 zero . The proportions of occurrence are positive: 3/6, negative: 2/6 and zeros: 1/6  .
'''
...
if __name__ == '__main__':
    ...
    n = int(input().strip())
    print("enter" , n, "element of array: ")
